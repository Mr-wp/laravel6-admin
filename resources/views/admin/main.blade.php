            ...
            <ul class="nav ace-nav">
                <li class="light-blue dropdown-modal">
                    <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                        <img class="nav-user-photo" src="{{$login_user['head_img']}}" alt="Photo"/>
...
<script>
    ...
    $(function () {
        ...
        //后台水印
        var name= "{{$login_user['name']??''}}";
        var realname = "{{ $login_user['realname']??''}}";
        // watermark('<p style="text-align:center">' + name + '</p><p style="text-align:center">' + realname + '</p>');
