            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{isset($info->id)?'edit':'add'}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! form_select($menus,request('parentid')?request('parentid'):(isset($info->id)?$info->parentid:0),' name="parentid" class="col-xs-10 col-sm-8" ','--作为一级菜单--') !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="c" value="{{$info->c??''}}" class="col-xs-10 col-sm-8">
                        </div>
                    </div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="a" value="{{$info->a??''}}" class="col-xs-10 col-sm-8">
                        </div>
                    </div>
                    <div class="space-4"></div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="listorder" value="{{isset($info->listorder)?$info->listorder:'999'}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! form_radio(\App\Models\AdminMenu::$statusArr,!empty($info->status)?$info->status:1,' name="status" ',70,'status') !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! form_radio(\App\Models\AdminMenu::$writeLogArr,!empty($info->write_log)?$info->write_log:2,' name="write_log" ',70,'write_log') !!}
                        </div>
                    </div>
