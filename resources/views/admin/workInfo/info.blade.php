            ...
            <div class="col-xs-12">
                ...
                <form class="form-horizontal" role="form" method="POST" action="{{isset($info->id)?'edit':'add'}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            {!! form_radio(\App\Models\WorkInfo::$reminderStatusArr,$info->reminder_status??1,' required="required" name="info[reminder_status]" ',60,'info[reminder_status]') !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="col-xs-5 col-sm-5" id="start_time" placeholder="" name="info[reminder_at]" required="required"  value="@if(isset($info->id)){{date('Y-m-d H:i:s',$info->reminder_at)}}@endif">
